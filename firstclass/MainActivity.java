...
public class MainActivity extends AppCompatActivity { //contextul metodei MainActivity
    ...
    @Override
    protected void onCreate(Bundle savedInstanceState) { //contextul metodei onCreate
        ...
        Log.i(MainActivityTag, "onCreate"); //afisam un mesaj de tip informatie
    }
}
